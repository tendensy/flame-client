...
import com.weiktonplaceint.game.core.DialogClientSettings;

import com.weiktonplaceint.game.gui.dialogs.BrDialogWindow;
import com.weiktonplaceint.game.gui.Speedometer;
import com.weiktonplaceint.game.gui.BrNotification;
...
public abstract class NvEventQueueActivity
    ...
    protected boolean systemInit()
    {
        ...
        //mBrNotification = new BrNotification(this);
        mBrDialogWindow = new BrDialogWindow(this);
 ...
 0    */
    ...
    public void showDialog(int dialogId, int dialogTypeId, String caption, String content, String leftBtnText, String rightBtnText) {
        runOnUiThread(() -> { this.mBrDialogWindow.show(dialogId, dialogTypeId, caption, content, leftBtnText, rightBtnText); });
    }
