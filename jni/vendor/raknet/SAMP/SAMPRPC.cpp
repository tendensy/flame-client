...
// ---> Custom RPC ID -- -- -- -- --
int RPC_SendFuel = 200;
int RPC_SendVerifyClient = 201;
int RPC_SetSpeedParams = 202;
int RPC_ShowSpeedometr = 203;

int RPC_SendExp = 204;
int RPC_SendEat = 205;

int RPC_ToggleChat = 206;
int RPC_ToggleHud = 207;
int RPC_ToggleButtons = 208;
// ---> Custom RPC ID -- -- -- -- --
