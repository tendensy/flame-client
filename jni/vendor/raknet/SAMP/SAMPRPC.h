...
// ---> Custom RPC ID -- -- -- -- --
extern int RPC_SendFuel;
extern int RPC_SendVerifyClient;
extern int RPC_SetSpeedParams;
extern int RPC_ShowSpeedometr;
extern int RPC_SendExp;
extern int RPC_SendEat;

extern int RPC_ToggleChat;
extern int RPC_ToggleHud;
extern int RPC_ToggleButtons;
// ---> Custom RPC ID -- -- -- -- --
