...
RwTexture* CCustomPlateManager::ProcessUaPlate(SCustomPlate& plate)
{
	...
	pText->m_pTexture = ((struct RwTexture* (*)(struct RwRaster*))(g_libGTASA + 0x1B1B4C + 1))(pTextRaster); // RwTextureCreate
...
RwTexture* CCustomPlateManager::ProcessTaxiPlate(SCustomPlate& plate)
{
	...
	pText->m_pTexture = ((struct RwTexture* (*)(struct RwRaster*))(g_libGTASA + 0x1B1B4C + 1))(pTextRaster); // RwTextureCreate
	pRegion->m_pTexture = ((struct RwTexture* (*)(struct RwRaster*))(g_libGTASA + 0x1B1B4C + 1))(pRegionRaster); // RwTextureCreate
...
RwTexture* CCustomPlateManager::ProcessRuPolicePlate(SCustomPlate& plate)
{
	...
	if (!m_pRuPoliceSprite->m_pTexture)
	{
		return nullptr;
	}
...
RwTexture* CCustomPlateManager::ProcessNoPlatePlate(SCustomPlate& plate)
{
	...
	if (!m_pNoPlateSprite->m_pTexture)
	{
		return nullptr;
	}
...
void CCustomPlateManager::Initialise()
{
	...
	m_pUaSprite->m_pTexture = (RwTexture*)LoadTextureFromDB("samp", "plate_ua");
	m_pRuSprite->m_pTexture = (RwTexture*)LoadTextureFromDB("samp", "plate_ru");
	m_pBuSprite->m_pTexture = (RwTexture*)LoadTextureFromDB("samp", "plate_bu");
	m_pKzSprite->m_pTexture = (RwTexture*)LoadTextureFromDB("samp", "plate_kz");
	m_pRuPoliceSprite->m_pTexture = (RwTexture*)LoadTextureFromDB("samp", "plate_ru_police");
	/*m_pTaxiSprite->m_pTexture = (RwTexture*)LoadTextureFromDB("samp", "plate_taxi");
	m_pRuGosSprite->m_pTexture = (RwTexture*)LoadTextureFromDB("samp", "plate_gos");
	m_pNoPlateSprite->m_pTexture = (RwTexture*)LoadTextureFromDB("samp", "plate_outside");*/
